...
CREATE VIEW comp_materialized_view_column AS
SELECT
...
FROM src_materialized_view_column s
JOIN tgt_materialized_view_column t USING (materialized_view_name, column_name)
