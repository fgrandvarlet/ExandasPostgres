...
(
    ...
    CONSTRAINT pk_src_index_column PRIMARY KEY (index_name, column_name)
);

CREATE TABLE tgt_index_column
(
    index_name varchar(63) not null,
    column_name varchar(63) not null,
    owner varchar(63) not null,
    ...
    access_privileges BLOB SUB_TYPE TEXT,
    options BLOB SUB_TYPE TEXT,
    CONSTRAINT pk_tgt_index_column PRIMARY KEY (index_name, column_name)
);
