...
CREATE TABLE src_materialized_view_column
(
    ...
    CONSTRAINT pk_src_materialized_view_column PRIMARY KEY (materialized_view_name, column_name)
);

CREATE TABLE tgt_materialized_view_column
(
    materialized_view_name varchar(63) not null,
    column_name varchar(63) not null,
    owner varchar(63) not null,
    ...
    access_privileges BLOB SUB_TYPE TEXT,
    options BLOB SUB_TYPE TEXT,
    CONSTRAINT pk_tgt_materialized_view_column PRIMARY KEY (materialized_view_name, column_name)
);
