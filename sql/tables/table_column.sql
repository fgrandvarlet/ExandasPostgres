...
(
    ...
    CONSTRAINT pk_src_table_column PRIMARY KEY (table_name, column_name)
);

CREATE TABLE tgt_table_column
(
    table_name varchar(63) not null,
    column_name varchar(63) not null,
    owner varchar(63) not null,
    ...
    access_privileges BLOB SUB_TYPE TEXT,
    options BLOB SUB_TYPE TEXT,
    CONSTRAINT pk_tgt_table_column PRIMARY KEY (table_name, column_name)
);
